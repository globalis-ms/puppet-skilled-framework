...
namespace Globalis\PuppetSkilled\Database\Magic\Relations\Concerns;
...
trait InteractsWithPivotTable
{
    ...
    public function toggle($ids, $touch = true)
    {
        ...
        $detach = array_values(array_intersect(
            array_pluck($this->newPivotQuery()->get(), $this->relatedKey),
            array_keys($records)
        ));
    ...
    public function sync($ids, $detaching = true)
    {
        ...
        $current = array_pluck($this->newPivotQuery()->get(), $this->relatedKey);
    ...
    public function attach($id, array $attributes = [], $touch = true)
    {
        ...
        foreach ($this->formatAttachRecords((array) $this->parseIds($id), $attributes) as $attribut) {
            $this->newPivot($attribut)->save();
        }
