...
use Globalis\PuppetSkilled\Database\Query\JoinClause;
...
class Grammar
{
    ...
    public function prepareBindingsForUpdate(array $bindings, array $values)
    {
        ...
        return array_values(
            array_merge($bindings['join'], $values, array_flatten($bindingsWithoutJoin))
        );
    }
     ...
     *
     * @param  \Globalis\PuppetSkilled\Database\Query\Expression|string  $table
     * @return string
     */
     ...
     *
     * @param  \Globalis\PuppetSkilled\Database\Query\Expression|string  $value
     ...
     *
     * @param  \Globalis\PuppetSkilled\Database\Query\Expression  $expression
     * @return string
     */
