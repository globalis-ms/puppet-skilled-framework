...
class BelongsToManyTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $model1 = new BelongsToManyModelStub;
        $model1->fill(['name' => 'taylor', 'pivot_user_id' => 1, 'pivot_role_id' => 2]);
        $model2 = new BelongsToManyModelStub;
    ...
    public function testModelsAreProperlyMatchedToParents()
    {
        ...
        $result1 = new BelongsToManyModelPivotStub;
        $result1->pivot->user_id = 1;
        $result2 = new BelongsToManyModelPivotStub;
        $result2->pivot->user_id = 2;
        $result3 = new BelongsToManyModelPivotStub;
        ...
        $model2 = new BelongsToManyModelStub;
        $model2->id = 2;
        $model3 = new BelongsToManyModelStub;
        $model3->id = 3;
    ...
    {
        $relation = $this->getMockBuilder('Globalis\PuppetSkilled\Database\Magic\Relations\BelongsToMany')->setMethods(['touchIfTouching'])->setConstructorArgs($this->getRelationArguments())->getMock();
    ...
    public function testAttachMethodConvertsCollectionToArrayOfKeys()
    {
        ...
        $collection = [
            m::mock('\Globalis\PuppetSkilled\Database\Magic\Model', ['getKey' => 1]),
            m::mock('\Globalis\PuppetSkilled\Database\Magic\Model', ['getKey' => 2]),
            m::mock('\Globalis\PuppetSkilled\Database\Magic\Model', ['getKey' => 3]),
        ];
    ...
    {
        $relation = m::mock('Globalis\PuppetSkilled\Database\Magic\Relations\BelongsToMany[get]', $this->getRelationArguments());
        $relation->shouldReceive('get')->once()->andReturn([new \StdClass]);
    ...
    {
        $relation = m::mock('Globalis\PuppetSkilled\Database\Magic\Relations\BelongsToMany[first]', $this->getRelationArguments());
    ...
    {
        $relation = m::mock('Globalis\PuppetSkilled\Database\Magic\Relations\BelongsToMany[get]', $this->getRelationArguments());
        $relation->shouldReceive('get')->once()->andReturn([new \StdClass, new \StdClass]);
    ...
    {
        $relation = $this->getMockBuilder('Globalis\PuppetSkilled\Database\Magic\Relations\BelongsToMany')->setMethods(['attach'])->setConstructorArgs($this->getRelationArguments())->getMock();
        $relation->getRelated()->shouldReceive('newInstance')->once()->andReturn($model = m::mock('\Globalis\PuppetSkilled\Database\Magic\Model'))->with(['attributes']);
    ...
    {
        $relation = $this->getMockBuilder('Globalis\PuppetSkilled\Database\Magic\Relations\BelongsToMany')->setMethods(['find'])->setConstructorArgs($this->getRelationArguments())->getMock();
    ...
    {
        $relation = $this->getMockBuilder('Globalis\PuppetSkilled\Database\Magic\Relations\BelongsToMany')->setMethods(['first'])->setConstructorArgs($this->getRelationArguments())->getMock();
    ...
    {
        $relation = $this->getMockBuilder('Globalis\PuppetSkilled\Database\Magic\Relations\BelongsToMany')->setMethods(['where'])->setConstructorArgs($this->getRelationArguments())->getMock();
    ...
    {
        $relation = $this->getMockBuilder('Globalis\PuppetSkilled\Database\Magic\Relations\BelongsToMany')->setMethods(['where', 'create'])->setConstructorArgs($this->getRelationArguments())->getMock();
        $relation->expects($this->once())->method('where')->with(['foo'])->will($this->returnValue($relation->getQuery()));
        $relation->getQuery()->shouldReceive('first')->once()->andReturn($model = m::mock('StdClass'));
    ...
    {
        $relation = $this->getMockBuilder('Globalis\PuppetSkilled\Database\Magic\Relations\BelongsToMany')->setMethods(['attach', 'detach'])->setConstructorArgs($this->getRelationArguments())->getMock();
        $query = m::mock('stdClass');
        $query->shouldReceive('from')->once()->with('user_role')->andReturn($query);
        $query->shouldReceive('where')->once()->with('user_id', 1)->andReturn($query);
        $relation->getQuery()->shouldReceive('getQuery')->andReturn($mockQueryBuilder = m::mock('StdClass'));
    ...
    {
        $relation = $this->getMockBuilder('Globalis\PuppetSkilled\Database\Magic\Relations\BelongsToMany')->setMethods(['attach', 'detach', 'touchIfTouching', 'updateExistingPivot'])->setConstructorArgs($this->getRelationArguments())->getMock();
        $query = m::mock('stdClass');
        $query->shouldReceive('from')->once()->with('user_role')->andReturn($query);
        $query->shouldReceive('where')->once()->with('user_id', 1)->andReturn($query);
        $relation->getQuery()->shouldReceive('getQuery')->andReturn($mockQueryBuilder = m::mock('StdClass'));
    ...
    {
        $relation = $this->getMockBuilder('Globalis\PuppetSkilled\Database\Magic\Relations\BelongsToMany')->setMethods(['touch', 'touchingParent'])->setConstructorArgs($this->getRelationArguments())->getMock();
    ...
    {
        $relation = $this->getMockBuilder('Globalis\PuppetSkilled\Database\Magic\Relations\BelongsToMany')->setMethods(['attach', 'detach', 'touchIfTouching', 'formatRecordsList'])->setConstructorArgs($this->getRelationArguments())->getMock();
        $query = m::mock('stdClass');
        $query->shouldReceive('from')->once()->with('user_role')->andReturn($query);
        $query->shouldReceive('where')->once()->with('user_id', 1)->andReturn($query);
        $relation->getQuery()->shouldReceive('getQuery')->andReturn($mockQueryBuilder = m::mock('StdClass'));
...
class BelongsToManyModelStub extends \Globalis\PuppetSkilled\Database\Magic\Model
{
    protected $guarded = [];
}

class BelongsToManyModelPivotStub extends \Globalis\PuppetSkilled\Database\Magic\Model
{
    public $pivot;

    public function __construct()
    {
        $this->pivot = new BelongsToManyPivotStub;
    }
}

class BelongsToManyPivotStub
{
    public $user_id;
}
